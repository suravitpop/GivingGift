...
function wpcf7_save_contact_form( $args = '', $context = 'save' ) {
	...
	$properties = array_merge( $properties, array(
		'form' => wpcf7_sanitize_form( $args['form'] ),
		'mail' => wpcf7_sanitize_mail( $args['mail'] ),
		'mail_2' => wpcf7_sanitize_mail( $args['mail_2'] ),
		'messages' => wpcf7_sanitize_messages( $args['messages'] ),
		'additional_settings' =>
			wpcf7_sanitize_additional_settings( $args['additional_settings'] ) ) );
...
function wpcf7_sanitize_form( $input ) {
	$output = trim( $input );
	return $output;
}

function wpcf7_sanitize_mail( $input ) {
...
function wpcf7_sanitize_messages( $input ) {
	$output = array();
...
function wpcf7_sanitize_additional_settings( $input ) {
	$output = trim( $input );
	return $output;
}
